...
var uq_voip = new ParseServer({
  databaseURI: databaseUri || 'mongodb://localhost:27017/dev',
  cloud: process.env.CLOUD_CODE_MAIN || __dirname + '/cloud/main.js',
  appId: process.env.APP_ID || 'tma.cirpack.uniquity',
  verbose: true,
  push: {
    android: {
        senderId: '1042768746539',
    ...
    ios:{
      //override on TMA key
      pfx:"public/tma-voip-certificate.p12",
      bundleId: "tma.cirpack.uniquity",
  ...
  masterKey: process.env.MASTER_KEY || 'master', //Add your master key here. Keep it secret!
  serverURL: process.env.SERVER_URL || 'https://pacific-brushlands-55337.herokuapp.com/voip',  // Don't forget to change to https if needed
  liveQuery: {
    classNames: ["Posts", "Comments"] // List of classes to support for query subscriptions
  }
});
